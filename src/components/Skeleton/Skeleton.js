...
const Skeleton = () => {
  return (
    <div class="w-full  mx-3 max-md:p-[5px] max-md:m-0">
      <div class="h-max shadow-md rounded-md items-center w-full max-md:mr-0 ">
        ...
        <div data-placeholder class="rounded-xl overflow-hidden relative bg-gray-400 max-md:mt-[5px]" style={{width:'250px',height:'30px',marginRight:'75px', }}></div> 
