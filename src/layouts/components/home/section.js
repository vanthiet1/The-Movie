    ...
    return (
        <>
         <div className='w-full h-auto relative max-md:mt-[100px]'>
           <img className='filter blur-[2px] w-full'  src="https://assets.nflxext.com/ffe/siteui/vlv3/c7f07b68-7989-4ff7-a31e-11c17dcc2fea/f8745b0e-cb07-404e-b5bf-e98d1584f283/VN-vi-20240422-popsignuptwoweeks-perspective_alpha_website_small.jpg" alt="" />
